...
const COUNCILORS = [
    ...
    { id: 'cannabis_botanist', name: 'Dr. Jane Grow',    party: 'Cannabis',  role: 'Cannabis Botanist', specialty: 'cannabis,botanics,plant-science', voteWeight: 1 },
    { id: 'cultivation_expert', name: 'Max Yield',       party: 'Cannabis',  role: 'Cultivation Expert', specialty: 'cultivation,growing,indoor,outdoor,soil,nutrients', voteWeight: 1 },
    { id: 'thc_analyst', name: 'Dr. Potency Paul',     party: 'Cannabis',  role: 'THC Analyst', specialty: 'thc,cbd,cannabinoids,potency,lab-testing', voteWeight: 1 },
    { id: 'terpene_specialist', name: 'Aroma Alex',     party: 'Cannabis',  role: 'Terpene Specialist', specialty: 'terpenes,flavonoids,aroma,flavor', voteWeight: 1 },
    { id: 'medical_cannabis', name: 'Dr. Wellness Willow', party: 'Cannabis',  role: 'Medical Cannabis Advisor', specialty: 'medical,medicinal,wellness,health,dosage', voteWeight: 1 },
    { id: 'plant_health_expert', name: 'Dr. Green',       party: 'Cannabis',  role: 'Plant Health Expert', specialty: 'plant-health,pests,diseases,nutrients,deficiencies', voteWeight: 1 },
    { id: 'general_plant_analyst', name: 'Zoe Plants',  party: 'Cannabis',  role: 'General Plant Analyst', specialty: 'plants,general,photosynthesis,watering,light', voteWeight: 1 },
    { id: 'harvest_master', name: 'Harvest Hannah',    party: 'Cannabis',  role: 'Harvest Master', specialty: 'harvest,curing,drying,trimming,preservation', voteWeight: 1 },
    { id: 'strain_breeder', name: 'Genetics Gary',     party: 'Cannabis',  role: 'Strain Breeder', specialty: 'genetics,breeding,strains,phenotypes,seeds', voteWeight: 1 },
    { id: 'environment_control', name: 'Control Chris', party: 'Cannabis',  role: 'Environment Controller', specialty: 'environment,temperature,humidity,vpd,lighting,hvac', voteWeight: 1 },
